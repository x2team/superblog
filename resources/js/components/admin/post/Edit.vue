				...
				<div class="row justify-content-around">
					<div class="col-md-10">
						...
						<div class="card card-primary">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" v-on:submit.prevent="updatePost()" enctype="multipart/form-data">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="file" 
											...
											>
										<img v-bind:src="updateImage()" style="width: 100px">
...
<script>
	export default {
		...
		created() {
			this.form.get(`update-post/${this.$route.params.id}`)
				.then((response) => {
		...
		methods: {
			...
			updateImage(){
				...
				if(img){
					if(img.length>100){ // Da bam chon hinh khac
						return this.form.photo;
					}
					else{ //Load lan dau tien // 3123123123.jpg
						return 'upload/image/'+this.form.photo;
					}
				}
			}
