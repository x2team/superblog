								...
								<div class="span8">
									<div class="post-image">
										<div class="post-heading">
											<h3><a href="#">{{ singlePost.title }} {{ this.$route.params.id }}</a></h3>
										</div>
										<img :src="`upload/image/${singlePost.photo}`" alt="">
									</div>
									<p>
									...
									<div class="bottom-article">
										<ul class="meta-post">
											...
											<li><i class="icon-folder-open"></i><a href="#"> {{ singlePost.category.name }}</a></li>
